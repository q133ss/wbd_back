...
<head>
    ...
    <title>WBDiscount - панель администратора</title>
              ...
              <span class="app-brand-logo demo">
                <span class="text-primary">
                  <svg
                    ...
                    <span class="app-brand-text demo menu-text fw-bold ms-2">WBDiscount</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="{{route('admin.index')}}" class="menu-link">
                        ...
                        <div class="text-truncate" data-i18n="Basic">Главная</div>
                    </a>
                </li>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{route('logout')}}">
                                        <i class="icon-base bx bx-power-off icon-md me-3"></i><span>Выйти</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
