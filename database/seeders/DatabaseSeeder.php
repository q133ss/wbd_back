    ...
    public function run(): void
    {
        ...
        $settings = [
            [
                ...
                'value' => 'Спасибо за заказ!<br><br>Чтобы получить кэшбек в размере {cashback}Р, вам нужно получить товар и написать отзыв.<br><br>Затем вам нужно загрузить 2 медиафайла:1) Фото с порезаным штрихкодом (чтобы не было возможности сдать товар обратно).<br><br>2) Скрин из кабинета Вб, где виден текст оставленного вами отзыва на наш товар'
            ],
            [
